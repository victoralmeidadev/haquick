...
// As mesmas telas do Storybook da web, sem uma linha diferente no template.
//
// É o teste mais forte da arquitetura: os templates são um arquivo só, e o que
// muda entre as plataformas é apenas de qual módulo os componentes vêm. Se uma
// tela sair diferente aqui, a diferença está num componente-folha.
const meta: Meta = {
  title: 'Telas',
  ...
  render: () => (
    ...
    >
      ...
      <XStack justify="between" align="center">
        ...
        <Link onPress={() => {}}>Esqueci a senha</Link>
      </XStack>
...
export const ListLoading: Story = {
  render: () => <ListTemplate title="Pessoas" subtitle="Carregando..." loading search={{}} />,
};
    ...
    >
      <MessageList>
        ...
        <Message role="assistant" avatar={<Avatar size="sm" initials="AI" intent="secondary" />}>
          Foram 37 cancelamentos, somando R$ 4.210,50.
        </Message>
        <TypingIndicator />
      </MessageList>
